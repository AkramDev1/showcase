    ...
    <div className={`min-h-screen ${styles.section} 
      ...
      <div className={`flex items-center 
        ...
        `}>
          ...
          <p className={`${reverse ? styles.blackText : styles.whiteText}${styles.descriptionText}`}>{description}
          </p>
          {showBtn && (
            <Button 
              assetUrl={assets.expo}
              //link to deployed nft markplace
              link="https://expo.dev/@akramdev/react_native_app?serviceType=classic&distribution=expo-go"
            />
          )}
        </div>
        <div
